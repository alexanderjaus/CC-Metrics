...
from tqdm.contrib.concurrent import (  # Import process_map for progress bars with multiprocessing
    process_map,
)
...
def main():
    ...
    parser.add_argument(
        "--gt",
        type=str,
        help="Path to the directory containing the ground truth nii.gz images",
    )
    parser.add_argument(
        "--cache_dir",
        type=str,
